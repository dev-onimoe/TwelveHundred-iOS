...
lblMessage.font = UIFont.init(name: "Poppins-Regular", size: 13)
...
bgView.addSubview(lblMessage)
    let btmConstraint = NSLayoutConstraint.init(item: lblMessage, attribute: NSLayoutConstraint.Attribute.bottom, relatedBy: NSLayoutConstraint.Relation.equal, toItem: bgView, attribute: NSLayoutConstraint.Attribute.bottom, multiplier: 1, constant: 10)
    bgView.addConstraint(btmConstraint)
